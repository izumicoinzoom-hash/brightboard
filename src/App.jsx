...
function KanbanApp({ currentUser = 'ログインユーザー', onLogout }) {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100 font-sans text-gray-800 overflow-hidden relative">
      ...
      {isCreateModalOpen && <CreateTaskModal fleetCars={fleetCars} defaultReceptionStaff={currentUser} staffOptionsConfig={staffOptionsConfig} onClose={() => setIsCreateModalOpen(false)} onSubmit={handleCreateTask} />}
...
// --- カード作成モーダルコンポーネント ---
function CreateTaskModal({ fleetCars = FLEET_CARS, defaultReceptionStaff = 'ログインユーザー', staffOptionsConfig = null, onClose, onSubmit }) {
